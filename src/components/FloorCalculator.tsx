...
export const FloorCalculator: React.FC<FloorCalculatorProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Step Navigation Bar with Visible Back Button */}
          ...
          {floorProducts.map((product, idx) => {
            ...
            return (
              <div
                ...
                className={`bg-white border rounded-xl p-4 sm:p-5 flex flex-col justify-between relative transition-all cursor-pointer shadow-xs hover:border-[#181818] ${
                  isSelected
              ...
              >
                {/* Badge */}
                <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded tracking-wider absolute top-3.5 right-3.5 ${
