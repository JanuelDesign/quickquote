...
export const translations = {
  en: {
    ...
    deliveryTaxable: 'Delivery Fee (No Tax)',
    ...
    payWithCardLabel: 'Pay with Debit / Credit Card (+3% processing fee)',
    payWithCardSubtext: 'Card terminal / Point of Sale (POS) 3% processing surcharge',
    cardFeeLabel: 'Debit/Credit Card Surcharge (3%):',
    packagingDetailsLabel: 'Packaging / Dispatch Details',
    paymentMethodsTitle: 'Accepted Payment Methods',
    zelleTitle: 'Zelle',
    zelleEmail: 'quickzelle@gmail.com',
    zelleAccountName: 'Brugge International',
    zelleCopied: 'Zelle email copied!',
    copyZelleBtn: 'Copy Zelle',
    otherPaymentMethods: 'We also accept Cash and POS / Card (Point of Sale).',
  ...
  es: {
    ...
    deliveryTaxable: 'Delivery Fijo (No Tax)',
    ...
    payWithCardLabel: 'Pagar con Tarjeta Débito / Crédito (+3% recargo)',
    payWithCardSubtext: 'Recargo del 3% por cobro en punto de venta (POS) o tarjeta',
    cardFeeLabel: 'Recargo Tarjeta Débito/Crédito (3%):',
    packagingDetailsLabel: 'Detalle de Cajas / Despacho',
    paymentMethodsTitle: 'Métodos de Pago Aceptados',
    zelleTitle: 'Zelle',
    zelleEmail: 'quickzelle@gmail.com',
    zelleAccountName: 'Brugge International',
    zelleCopied: '¡Email de Zelle copiado!',
    copyZelleBtn: 'Copiar Zelle',
    otherPaymentMethods: 'Aceptamos también Efectivo y Punto de Venta (POS / Tarjeta).',
